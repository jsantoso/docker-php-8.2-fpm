...
ADD conf.d/php.ini /etc/php/8.2/php.ini
ADD conf.d/xdebug.ini /etc/php/8.2/xdebug.ini

RUN mkdir -p /etc/php/8.2/fpm/conf.d
RUN ln -s /etc/php/8.2/php.ini /etc/php/8.2/fpm/conf.d/90-tris.ini
RUN ln -s /etc/php/8.2/xdebug.ini /etc/php/8.2/fpm/conf.d/90-xdebug.ini

RUN mkdir -p /etc/php/8.2/cli/conf.d
RUN ln -s /etc/php/8.2/php.ini /etc/php/8.2/cli/conf.d/90-tris.ini
RUN ln -s /etc/php/8.2/xdebug.ini /etc/php/8.2/cli/conf.d/90-xdebug.ini

RUN mkdir -p /usr/local/etc/php/conf.d
RUN ln -s /etc/php/8.2/php.ini /usr/local/etc/php/conf.d/90-tris.ini
RUN ln -s /etc/php/8.2/xdebug.ini /usr/local/etc/php/conf.d/90-xdebug.ini
